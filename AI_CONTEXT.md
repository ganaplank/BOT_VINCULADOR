...
- `[x]` Limitar altura da lista de unidades e mapeamento de blocos para evitar rolagem infinita:
...
- `[x]` Corrigir abertura de aba e formato das unidades no código de leitura:
  ...
  - `[x]` Compilar novo executável (`BotVinculadorPRO.exe`) (Apenas após autorização do usuário)
